...
namespace MRPApp.View.Schedule
{
    public partial class ScheduleList : Page
    {
        ...
        {
            LblPlantCode.Visibility = LblSchDate.Visibility = LblEndTime.Visibility = LblSchLoadTime.Visibility = 
                LblStartTime.Visibility = LblSchAmount.Visibility = LblSchFacilityID.Visibility = Visibility.Hidden;
        }
        ...
        public bool IsValidInputs()
        {
            ...
            if(CboPlantCode.SelectedValue != null && string.IsNullOrEmpty(DtpSchDate.Text))
            {
                ...
                // PC01001 (수원) 2021-06-24 있으면 중복안됨
            ...
            if (NudSchAmount.Value <= 0)
            {
                ...
                LblSchAmount.Text = "계획수량은 0개이상 입니다";
                isValid = false;
            }
        ...
        private async void BtnUpdate_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                {
                    Commons.LOGGER.Info($"데이터 수정 성공 : "); // 로그
                    ClearInputs();
                    LoadGridData();
                }
            }
